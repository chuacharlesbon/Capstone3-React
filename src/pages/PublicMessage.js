...
export default function PublicMessage(){
	...
	return(
		...
		<Form id="form-message" className="border border-secondary p-3 my-3 mx-auto" onSubmit={e => sendPMessage(e)}>
			...
			<Form.Label>Sender Name: {user.userName}</Form.Label>
			...
			<Form.Control type="text" placeholder="Enter your Name here" required value={sender} onChange={e => setSender(e.target.value)}/>
