...
export default function OrderCard ({orderProp}) {
	...
	return (
		...
		<Card.Body>
			...
			<Button /*variant="warning"*/ as= {Link} to={`/orders/payOrder/${_id}`} className="d-block my-2 background-play text-dark" >Complete the Payment</Button>
			</Col>
			<Col xs={8} md={4} lg={3} xl={2} >
			<Button variant="secondary" onClick={() => cancelOrder(`${_id}`)} className="d-block my-2 text-dark" >Cancel Order</Button>
			</Col>
			</Row>
		</Card.Body>
		</Card>
